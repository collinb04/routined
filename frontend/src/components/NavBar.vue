        ...
        >
          ...
          >
            ...
            <div class="p-1.5 flex flex-col">
              ...
              <button
                class="flex items-center gap-2.5 px-3 py-2 rounded-lg text-[13px] text-red-500 hover:bg-red-500 hover:text-white active:bg-red-600 transition-colors w-full text-left"
                @click="handleLogout"
              >
                <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
