  ...
  clues: [
    {
      ...
      question: '"Standard subtractive notation" — 4 is IV, 9 is IX, 40 is XL. What does this tell you about the symbol table you need?',
      options: [
    ...
    {
      id: 'greedy-strategy',
      question: 'The conversion appends symbols greedily from largest to smallest. Why does greedy work here?',
      options: [
    ...
    {
      id: 'output-structure',
      question: 'The output is a string. What does the conversion loop look like?',
      options: [
        ...
        { label: 'Recurse: convert the most significant digit, then recurse on the remainder', isCorrect: false, feedback: 'Recursion would work but adds call-stack overhead for no benefit. An iterative while loop that subtracts and appends is direct and avoids depth issues.' },
      ],
    ...
    {
      id: 'constraint-range',
      question: '1 ≤ num ≤ 3999. What does the upper bound tell you about the maximum Roman numeral symbol needed?',
      options: [
