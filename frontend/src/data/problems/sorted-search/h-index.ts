  ...
  clues: [
    {
      ...
      question: '"Maximum h such that at least h papers have at least h citations." This self-referential definition implies…',
      options: [
    ...
    {
      id: 'sorting-approach',
      question: 'Sorting citations in descending order simplifies the search. Why?',
      options: [
    ...
    {
      id: 'output-type',
      question: 'The output is a single integer h, not a list of papers. What does this mean about how you accumulate the answer?',
      options: [
        ...
        { label: 'Binary search for h directly in the sorted array', isCorrect: false, feedback: 'Binary search on h is possible but requires a separate feasibility check. After sorting, a simple linear scan is both simpler and sufficient at n ≤ 5000.' },
      ],
