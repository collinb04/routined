export default {
  ...
  clues: [
    {
      id: 'output-structure',
      question: 'runningSum[i] = sum(nums[0]...nums[i]). What does this definition imply about how you build each output value?',
      options: [
    ...
    },
    {
      ...
      question: 'nums.length ≤ 1000. What complexity is acceptable here?',
      options: [
    ...
    {
      id: 'output-type',
      question: 'The output is an array the same length as nums. What does this tell you about the traversal?',
      options: [
