  ...
  clues: [
    {
      ...
      question: '"A subsequence maintains relative order but not necessarily contiguous positions." What does this mean for how you scan <code>t</code>?',
      options: [
    ...
    },
    {
      ...
      question: '"0 ≤ s.length ≤ 100" and "0 ≤ t.length ≤ 10⁴" — both can be empty. Which empty-string case must return true?',
      options: [
    ...
    },
    {
      ...
      question: 's.length ≤ 100 and t.length ≤ 10⁴. What is the complexity of a single linear scan of t?',
      options: [
