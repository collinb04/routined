  ...
  clues: [
    {
      ...
      question: 'nums.length ≤ 10⁵. What does this tell you about acceptable time complexity?',
      options: [
    ...
    {
      id: 'flip-budget',
      question: '"At most k zeros" can be flipped. What does this budget imply about your window?',
      options: [
    ...
    {
      id: 'binary-values',
      question: 'nums[i] is 0 or 1 — values are binary. How does this simplify tracking the window content?',
      options: [
    ...
    {
      id: 'output-length',
      question: 'The output is the maximum length, not the window\'s start index or contents. What does that mean for your tracking?',
      options: [
