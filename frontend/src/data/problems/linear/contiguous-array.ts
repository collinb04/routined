  ...
  clues: [
    {
      ...
      question: 'Equal numbers of 0s and 1s means count(1s) − count(0s) = 0 for the subarray. What does treating 0 as −1 and 1 as +1 give you?',
      options: [
        ...
        { label: 'A prefix product instead of a prefix sum', isCorrect: false, feedback: 'Products of +1 and −1 collapse sign information and cannot tell you the net count difference.' },
      ],
    ...
    },
    {
      ...
      question: 'You need the earliest index where each prefix-sum value was seen. What structure gives O(1) first-occurrence lookup?',
      options: [
        ...
        { label: 'A hash map from prefix_sum value to first index seen', isCorrect: true },
    ...
    {
      id: 'seed-the-map',
      question: 'Before scanning, you initialize the map with {0: -1}. Why is that starting entry necessary?',
      options: [
    ...
    },
    {
      ...
      options: [
        ...
        { label: 'O(n) single-pass with a hash map is the target', isCorrect: true },
