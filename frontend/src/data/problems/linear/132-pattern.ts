export default {
  ...
  clues: [
    ...
    },
    {
      ...
      question: 'The condition is nums[i] < nums[k] < nums[j] with i < j < k. The "3" (nums[j]) is the largest, in the middle position. What does this imply about how you search?',
      options: [
        ...
        { label: 'Scan right to left so nums[j] can be tracked via a stack', isCorrect: true },
    ...
    {
      id: 'output-type',
      question: 'The output is a boolean — true if any valid triple exists. What does that let you do?',
      options: [
