export default {
  ...
  clues: [
    {
      id: 'boolean-output',
      question: 'The output is true or false — can you finish all courses? What single graph property does this reduce to?',
      options: [
    ...
    },
    {
      ...
      question: '[a, b] means take b before a. In your adjacency list, which direction should edges point?',
      options: [
    ...
    },
    {
      ...
      question: 'In Kahn\'s algorithm, how do you know a cycle exists after BFS finishes?',
      options: [
        { label: 'Some node\'s in-degree never reached 0', isCorrect: true },
        { label: 'The BFS queue became empty before processing any node', isCorrect: false, feedback: 'The queue starts with all in-degree-0 nodes. If there are any such nodes, the queue is never initially empty. An empty final queue alone doesn\'t signal a cycle — you need to compare processed count to numCourses.' },
    ...
    {
      id: 'constraint-size',
      question: 'numCourses ≤ 2000 and up to 5000 prerequisites. What is the complexity of Kahn\'s algorithm here?',
      options: [
